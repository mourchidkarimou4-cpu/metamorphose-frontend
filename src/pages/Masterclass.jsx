  ...
  return (
    <div style={{ textAlign:"center", padding:"40px 32px", background:"rgba(37,211,102,.05)", border:"1px solid rgba(37,211,102,.2)", borderRadius:"6px", animation:"fadeUp .6s both" }}>
      ...
      <div style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:"12px" }}>
        <a href={whatsappGroupe} target="_blank" rel="noreferrer" className="btn-wa" style={{ width:"100%", maxWidth:"420px" }}>
              ...
              <div style={{ position:"relative", paddingBottom:"120%", background:"linear-gradient(135deg,rgba(194,24,91,.1),rgba(201,169,106,.08))", border:"1px solid rgba(201,169,106,.15)", borderRadius:"4px", overflow:"hidden" }}>
                {photoPrelia ? (
                  ...
                  <div style={{ position:"absolute", inset:0, display:"flex", alignItems:"center", justifyContent:"center" }}>
                    <p style={{ fontFamily:"var(--ff-b)", fontSize:".65rem", letterSpacing:".15em", textTransform:"uppercase", color:"rgba(201,169,106,.3)", textAlign:"center", padding:"16px" }}>Photo Prélia APEDO AHONON</p>
                  </div>
                )}
              </div>
              <div>
            ...
            <div className="prelia-grid reveal" style={{ display:"grid", gridTemplateColumns:"260px 1fr", gap:"48px", alignItems:"start" }}>
              ...
              <div>
                <p style={{ fontFamily:"var(--ff-b)", fontWeight:300, fontSize:".9rem", color:"rgba(248,245,242,.7)", lineHeight:1.85, marginBottom:"16px" }}>
                  Je suis <strong style={{color:"var(--blanc)"}}>Prélia APEDO AHONON</strong>, Conseillère Coach en image Certifiée par l'Institut de bien être de Marseille. Experte en transformation personnelle. Fondatrice de la marque White & Black et du programme Méta'Morph'Ose. Mariée et mère de deux enfants.
                </p>
