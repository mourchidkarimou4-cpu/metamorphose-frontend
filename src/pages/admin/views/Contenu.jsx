...
function ConfigView({ api, toast, sectionFilter = null, refreshKey = 0 }) {
  ...
  const SCHEMA = {
    ...
    masterclass: [
      ...
      { cle:"masterclass_temo_photo_1", label:"Photo Témoignante 1 — Georgine (URL)",  type:"url", placeholder:"https://res.cloudinary.com/..." },
      { cle:"masterclass_temo_photo_2", label:"Photo Témoignante 2 — Marie (URL)",     type:"url", placeholder:"https://res.cloudinary.com/..." },
      { cle:"masterclass_temo_photo_3", label:"Photo Témoignante 3 — Olivia (URL)",    type:"url", placeholder:"https://res.cloudinary.com/..." },
      { cle:"masterclass_temo_photo_4", label:"Photo Témoignante 4 — Catherine (URL)", type:"url", placeholder:"https://res.cloudinary.com/..." },
      { cle:"masterclass_temo_photo_5", label:"Photo Témoignante 5 — Daniella (URL)",  type:"url", placeholder:"https://res.cloudinary.com/..." },
      { cle:"masterclass_temo_photo_6", label:"Photo Témoignante 6 — Aminata (URL)",   type:"url", placeholder:"https://res.cloudinary.com/..." },
      { cle:"masterclass_temo_photo_7", label:"Photo Témoignante 7 — Ginette (URL)",   type:"url", placeholder:"https://res.cloudinary.com/..." },
      { cle:"masterclass_temo_photo_8", label:"Photo Témoignante 8 — La Reine (URL)",  type:"url", placeholder:"https://res.cloudinary.com/..." },
    ],
    evenements: [
