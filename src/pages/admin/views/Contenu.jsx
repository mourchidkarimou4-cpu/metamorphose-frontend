...
function ConfigView({ api, toast, sectionFilter = null, refreshKey = 0 }) {
  ...
  const SCHEMA = {
    hero: [
      ...
      { cle:"hero_btn1",      label:"Bouton principal",      type:"text",  placeholder:"Je rejoins l'aventure" },
      { cle:"hero_btn2",      label:"Bouton secondaire",     type:"text",  placeholder:"Découvrir le programme" },
      { cle:"favicon",        label:"Favicon (URL)",         type:"text",  placeholder:"https://..." },
      { cle:"slide_1",        label:"Slide 1 (URL image)",   type:"text",  placeholder:"https://..." },
      { cle:"slide_2",        label:"Slide 2 (URL image)",   type:"text",  placeholder:"https://..." },
      { cle:"slide_3",        label:"Slide 3 (URL image)",   type:"text",  placeholder:"https://..." },
      { cle:"slide_4",        label:"Slide 4 (URL image)",   type:"text",  placeholder:"https://..." },
      { cle:"slide_5",        label:"Slide 5 (URL image)",   type:"text",  placeholder:"https://..." },
    ...
    avant_apres: [
      { cle:"aa_avant1", label:"Avant 1", type:"text", placeholder:"Peur du regard des autres" },
      { cle:"aa_apres1", label:"Après 1", type:"text", placeholder:"Confiance rayonnante" },
      { cle:"aa_avant2", label:"Avant 2", type:"text", placeholder:"Image floue" },
      { cle:"aa_apres2", label:"Après 2", type:"text", placeholder:"Style aligné" },
      { cle:"aa_avant3", label:"Avant 3", type:"text", placeholder:"Hésitation" },
      { cle:"aa_apres3", label:"Après 3", type:"text", placeholder:"Action concrète" },
      { cle:"aa_avant4", label:"Avant 4 (optionnel)", type:"text", placeholder:"..." },
      { cle:"aa_apres4", label:"Après 4 (optionnel)", type:"text", placeholder:"..." },
      { cle:"aa_avant5", label:"Avant 5 (optionnel)", type:"text", placeholder:"..." },
      { cle:"aa_apres5", label:"Après 5 (optionnel)", type:"text", placeholder:"..." },
    ...
    prelia: [
      ...
      { cle:"prelia_texte1",    label:"Texte paragraphe 1",   type:"textarea", placeholder:"Son histoire..." },
      { cle:"prelia_texte2",    label:"Texte paragraphe 2",   type:"textarea", placeholder:"..." },
    ...
    cta: [
      { cle:"cta_btn1", label:"Bouton principal", type:"text", placeholder:"Je rejoins Méta'Morph'Ose" },
      { cle:"cta_btn2", label:"Bouton secondaire", type:"text", placeholder:"Découvrir Méta'Morph'Ose" },
    ...
    footer: [
      ...
      { cle:"footer_tel2", label:"Téléphone 2", type:"text", placeholder:"+229 01 59 37 65 60" },
    ...
    stats_site: [
      ...
      { cle:"stat_label2", label:"Label stat 2", type:"text", placeholder:"Pays représentés" },
      { cle:"stat_label3", label:"Label stat 3", type:"text", placeholder:"Semaines d'accompagnement" },
      { cle:"stat_label4", label:"Label stat 4", type:"text", placeholder:"Taux de satisfaction" },
    ...
    diagnostic: [
      ...
      { cle:"res_guide_point1", label:"Point guide 1", type:"text", placeholder:"Prioriser ce qui compte vraiment" },
      { cle:"res_guide_point2", label:"Point guide 2", type:"text", placeholder:"Sortir de la procrastination" },
      { cle:"res_guide_point3", label:"Point guide 3", type:"text", placeholder:"Passer à l'action avec discipline" },
