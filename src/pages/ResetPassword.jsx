...
export default function ResetPassword() {
  ...
  async function demanderReset(e) {
    ...
    try {
      await fetch(API_URL + 'https://metamorphose-backend.onrender.com/api/auth/reset-password/', {
        method: "POST",
  ...
  async function confirmerReset(e) {
    ...
    try {
      const res = await fetch(API_URL + 'https://metamorphose-backend.onrender.com/api/auth/reset-confirm/', {
        method: "POST",
        headers: { "Content-Type": "application/json" },
