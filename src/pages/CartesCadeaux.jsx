...
const FORMULES = [
  { id:"F1", label:"ESSENTIELLE",    prix:"70 000",  color:"#C2185B", desc:"Accompagnement de groupe en ligne" },
  { id:"F2", label:"PERSONNALISÉE",  prix:"160 000", color:"#C9A96A", desc:"Accompagnement individuel en ligne", featured:true },
  { id:"F3", label:"IMMERSION",      prix:"267 000", color:"#A8C8E0", desc:"Accompagnement de groupe en présentiel" },
  { id:"F4", label:"VIP",            prix:"370 000", color:"#D8C1A0", desc:"Accompagnement individuel en présentiel" },
];
