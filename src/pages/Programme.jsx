...
export default function Programme() {
  ...
  const formats = [
    ...
    { code:"F2", label:"PERSONNALISÉE",  prix:"160 000", color:"#C9A96A", badge:"Populaire", detail:"Accompagnement individuel en ligne avec Coach Prélia. 3 séances immersives + analyse personnalisée.", featured:true },
  ...
  return (
    <>
      <style>{STYLES}</style>
      <Navbar />
<div style={{ background:"linear-gradient(180deg,#0A0A0A 0%,#1f1408 25%,#3a2518 60%,#2e1e14 100%)", color:"#F8F5F2", fontFamily:"'Montserrat',sans-serif", minHeight:"100vh" }}>
